          ...
          <tbody>
            <tr v-for="clar in clarifications" :key="`clar-${clar.id}`">
              <td v-if="clar.task" class="table__task-data">
                <NuxtLink :to="`../tasks/${clar.task.slug}`" append>
...
import ClarificationAnswerModal from '../../../comp/modals/ClarificationAnswerModal.vue'
import ClarificationQuestionModal from '../../../comp/modals/ClarificationQuestionModal.vue'
