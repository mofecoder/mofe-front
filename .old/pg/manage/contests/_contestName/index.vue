<template>
  <v-container fluid>
    <v-layout v-if="contest" justify-center>
      <v-flex xl6 lg8 md10>
        <v-btn class="mb-3" nuxt to=".." append variant="text" color="purple"
          >コンテスト一覧に戻る</v-btn
        >
        <InformationCard
        ...
        />
        <TimeCardEdit
          v-model:start="contest.startAt"
          v-model:end="contest.endAt"
          class="my-4"
...
import ProblemsCard from '../../../../comp/contestAdmin/ProblemsCard.vue'
import TimeCardEdit from '../../../../comp/contestAdmin/TimeCardEdit.vue'
import SettingsCard from '../../../../comp/contestAdmin/SettingsCard.vue'
import InformationCard from '../../../../comp/contestAdmin/InformationCard.vue'
import { ContestDetailManage } from '~/types/contest'
import AddProblemCard from '../../../../comp/contestAdmin/AddProblemCard.vue'
import ProblemListCard from '../../../../comp/contestAdmin/ProblemListCard.vue'
